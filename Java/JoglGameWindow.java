...
/**
 * An implementation of GameWindow that will use OPENGL (JOGL) to render the
 * scene. Its also responsible for monitoring the keyboard using AWT.
 * 
 * @author Kevin Glass
 */
public class JoglGameWindow implements GLEventListener, GameWindow
{
	...
	/**
	 * Retrieve access to the texture loader that converts images into OpenGL
	 * textures. Note, this has been made package level since only other parts
	 * of the JOGL implementations need to access it.
	 * 
	 * @return The texture loader that can be used to load images into OpenGL
	 *         textures.
	 */
	...
	/**
	 * Get access to the GL context that can be used in JOGL to call OpenGL
	 * commands.
	 * 
	...
	/**
	 * Called by the JOGL rendering process to display a frame. In this case its
	 * responsible for blanking the display and then notifing any registered
	 * callback that the screen requires rendering.
	 * 
	 * @param drawable
