...
/**
 * The game over screen displays the final score and a game over text and waits
 * for the user to touch the screen in which case it will signal that it is done
 * to the orchestrating GdxInvaders class.
 *
 * @author mzechner
 */
