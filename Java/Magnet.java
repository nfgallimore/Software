...
class Cell extends Point {
        ...
        Point cellCenterScreen () { return new Point ((int)((x-0.5)*Gui.CELLSIZE), (int)((y-0.5)*Gui.CELLSIZE)); }
        Point[] cellCornersScreen () {
                Point[] position;
                position = new Point[4];
                position[0] = new Point ((x-1)*Gui.CELLSIZE, (y-1)*Gui.CELLSIZE);
                position[1] = new Point (x*Gui.CELLSIZE, (y-1)*Gui.CELLSIZE);
                position[2] = new Point (x*Gui.CELLSIZE, y*Gui.CELLSIZE);
                position[3] = new Point ((x-1)*Gui.CELLSIZE, y*Gui.CELLSIZE);
                return position;
        }
...
class Magnet {
        ...
        private int width () { return (Math.abs(north.x-south.x)+1)*Gui.CELLSIZE; }
        private int height () { return (Math.abs(north.y-south.y)+1)*Gui.CELLSIZE; }
        private Point centerScreen () { return new Point ((north.x+south.x-1)*Gui.CELLSIZE/2, (north.y+south.y-1)*Gui.CELLSIZE/2); }
        ...
        void draw (Graphics2D g2) {
                ...
                g2.setFont(new Font("Arial", Font.PLAIN, Gui.POLEFONTSIZE));
                g2.drawString("N", northScreen().x-(int)(0.42*Gui.POLEFONTSIZE), northScreen().y+(int)(0.42*Gui.POLEFONTSIZE));
                g2.drawString("S", southScreen().x-(int)(0.42*Gui.POLEFONTSIZE), southScreen().y+(int)(0.42*Gui.POLEFONTSIZE));
        }
