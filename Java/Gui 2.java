...
class Gui {
        ...
        public static final int POLEFONTSIZE = Gui.CELLSIZE*2/3;
        public static final int YOUWINFONTSIZE = Gui.CELLSIZE;
        ...
        public static final int YOUWINX = WIDTH/2 - 2*Gui.CELLSIZE;
