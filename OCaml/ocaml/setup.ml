...
(* OASIS_START *)
(* DO NOT EDIT (digest: 76177b1b6cb1464543aa04713f66bbdb) *)
(*
...
let setup_t =
  {
     ...
     test = [];
     doc = [("api-ref", OCamlbuildDocPlugin.doc_build "src/lib")];
     install = InternalInstallPlugin.install;
     uninstall = InternalInstallPlugin.uninstall;
     clean = [OCamlbuildPlugin.clean];
     clean_test = [];
     clean_doc = [("api-ref", OCamlbuildDocPlugin.doc_clean "src/lib")];
     distclean = [];
     distclean_test = [];
     distclean_doc = [];
     package =
       {
          ...
          homepage =
            Some "http://forge.ocamlcore.org/projects/dirvish-stats/";
          ...
          files_ab = ["src/dirvish-stats/conf.ml.ab"];
          sections =
            [
               Library
                 ({
                     cs_name = "dirvish-stats";
               ...
               Executable
                 ({
                     ...
                     },
                   {
                      bs_build = [(OASISExpr.EBool true, true)];
                      bs_install = [(OASISExpr.EBool true, true)];
                      bs_path = "src/dirvish-stats";
                      bs_compiled_object = Best;
                      bs_build_depends =
                        [
                           InternalLibrary "dirvish-stats";
                           FindlibPackage
                             ("fileutils",
               ...
               Doc
                 ({
                     ...
                     },
                   {
                      ...
                      doc_install_dir = "$htmldir/dirvish-stats";
                      doc_title = "API reference for DirvishStats";
                      doc_authors = [];
                      doc_abstract = None;
                      doc_format = OtherDoc;
                      doc_data_files = [];
               ...
               SrcRepo
                 ({
                     ...
                     },
                   {
                      src_repo_type = Git;
                      src_repo_location =
                        "https://forge.ocamlcore.org/anonscm/git/dirvish-stats/dirvish-stats.git";
     ...
     oasis_version = "0.3.1";
     oasis_digest = Some "\232\001D,H\246\243\210\024\127Pw|\003\019/";
     oasis_exec = None;
     oasis_setup_args = [];
     setup_update = false;
     };;
