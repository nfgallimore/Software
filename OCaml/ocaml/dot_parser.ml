...
open Parsing;;
let _ = parse_error;;
# 23 "src_ext/ocamlgraph/src/dot_parser.mly"
  open Dot_ast
  open Parsing
...
# 38 "src_ext/ocamlgraph/src/dot_parser.ml"
let yytransl_const = [|
  258 (* COLON *);
  259 (* COMMA *);
  260 (* EQUAL *);
...
; (fun __caml_parser_env ->
    ...
    Obj.repr(
# 52 "src_ext/ocamlgraph/src/dot_parser.mly"
    ( { strict = _1; digraph = _2; id = _3; stmts = _5 } )
# 200 "src_ext/ocamlgraph/src/dot_parser.ml"
               : Dot_ast.file))
; (fun __caml_parser_env ->
    Obj.repr(
# 56 "src_ext/ocamlgraph/src/dot_parser.mly"
                ( false )
# 206 "src_ext/ocamlgraph/src/dot_parser.ml"
               : 'strict_opt))
; (fun __caml_parser_env ->
    Obj.repr(
# 57 "src_ext/ocamlgraph/src/dot_parser.mly"
                ( true )
# 212 "src_ext/ocamlgraph/src/dot_parser.ml"
               : 'strict_opt))
; (fun __caml_parser_env ->
    Obj.repr(
# 61 "src_ext/ocamlgraph/src/dot_parser.mly"
          ( false )
# 218 "src_ext/ocamlgraph/src/dot_parser.ml"
               : 'graph_or_digraph))
; (fun __caml_parser_env ->
    Obj.repr(
# 62 "src_ext/ocamlgraph/src/dot_parser.mly"
          ( true )
# 224 "src_ext/ocamlgraph/src/dot_parser.ml"
               : 'graph_or_digraph))
; (fun __caml_parser_env ->
    Obj.repr(
# 66 "src_ext/ocamlgraph/src/dot_parser.mly"
                ( [] )
# 230 "src_ext/ocamlgraph/src/dot_parser.ml"
               : 'stmt_list))
; (fun __caml_parser_env ->
    let _1 = (Parsing.peek_val __caml_parser_env 0 : 'list1_stmt) in
    Obj.repr(
# 67 "src_ext/ocamlgraph/src/dot_parser.mly"
                ( _1 )
# 237 "src_ext/ocamlgraph/src/dot_parser.ml"
               : 'stmt_list))
; (fun __caml_parser_env ->
    let _1 = (Parsing.peek_val __caml_parser_env 1 : 'stmt) in
    let _2 = (Parsing.peek_val __caml_parser_env 0 : 'semicolon_opt) in
    Obj.repr(
# 71 "src_ext/ocamlgraph/src/dot_parser.mly"
                     ( [_1] )
# 245 "src_ext/ocamlgraph/src/dot_parser.ml"
               : 'list1_stmt))
; (fun __caml_parser_env ->
    ...
    Obj.repr(
# 72 "src_ext/ocamlgraph/src/dot_parser.mly"
                                ( _1 :: _3 )
# 254 "src_ext/ocamlgraph/src/dot_parser.ml"
               : 'list1_stmt))
; (fun __caml_parser_env ->
    Obj.repr(
# 76 "src_ext/ocamlgraph/src/dot_parser.mly"
                ( () )
# 260 "src_ext/ocamlgraph/src/dot_parser.ml"
               : 'semicolon_opt))
; (fun __caml_parser_env ->
    Obj.repr(
# 77 "src_ext/ocamlgraph/src/dot_parser.mly"
                ( () )
# 266 "src_ext/ocamlgraph/src/dot_parser.ml"
               : 'semicolon_opt))
; (fun __caml_parser_env ->
    let _1 = (Parsing.peek_val __caml_parser_env 0 : 'node_stmt) in
    Obj.repr(
# 81 "src_ext/ocamlgraph/src/dot_parser.mly"
            ( _1 )
# 273 "src_ext/ocamlgraph/src/dot_parser.ml"
               : 'stmt))
; (fun __caml_parser_env ->
    let _1 = (Parsing.peek_val __caml_parser_env 0 : 'edge_stmt) in
    Obj.repr(
# 82 "src_ext/ocamlgraph/src/dot_parser.mly"
            ( _1 )
# 280 "src_ext/ocamlgraph/src/dot_parser.ml"
               : 'stmt))
; (fun __caml_parser_env ->
    let _1 = (Parsing.peek_val __caml_parser_env 0 : 'attr_stmt) in
    Obj.repr(
# 83 "src_ext/ocamlgraph/src/dot_parser.mly"
            ( _1 )
# 287 "src_ext/ocamlgraph/src/dot_parser.ml"
               : 'stmt))
; (fun __caml_parser_env ->
    let _1 = (Parsing.peek_val __caml_parser_env 2 : Dot_ast.id) in
    let _3 = (Parsing.peek_val __caml_parser_env 0 : Dot_ast.id) in
    Obj.repr(
# 84 "src_ext/ocamlgraph/src/dot_parser.mly"
              ( Equal (_1, _3) )
# 295 "src_ext/ocamlgraph/src/dot_parser.ml"
               : 'stmt))
; (fun __caml_parser_env ->
    let _1 = (Parsing.peek_val __caml_parser_env 0 : 'subgraph) in
    Obj.repr(
# 85 "src_ext/ocamlgraph/src/dot_parser.mly"
            ( Subgraph _1 )
# 302 "src_ext/ocamlgraph/src/dot_parser.ml"
               : 'stmt))
; (fun __caml_parser_env ->
    let _1 = (Parsing.peek_val __caml_parser_env 1 : 'node_id) in
    let _2 = (Parsing.peek_val __caml_parser_env 0 : 'attr_list_opt) in
    Obj.repr(
# 89 "src_ext/ocamlgraph/src/dot_parser.mly"
                        ( Node_stmt (_1, _2) )
# 310 "src_ext/ocamlgraph/src/dot_parser.ml"
               : 'node_stmt))
; (fun __caml_parser_env ->
    ...
    Obj.repr(
# 93 "src_ext/ocamlgraph/src/dot_parser.mly"
                              ( Edge_stmt (_1, _2, _3) )
# 319 "src_ext/ocamlgraph/src/dot_parser.ml"
               : 'edge_stmt))
; (fun __caml_parser_env ->
    let _2 = (Parsing.peek_val __caml_parser_env 0 : 'attr_list) in
    Obj.repr(
# 97 "src_ext/ocamlgraph/src/dot_parser.mly"
                  ( Attr_graph _2 )
# 326 "src_ext/ocamlgraph/src/dot_parser.ml"
               : 'attr_stmt))
; (fun __caml_parser_env ->
    let _2 = (Parsing.peek_val __caml_parser_env 0 : 'attr_list) in
    Obj.repr(
# 98 "src_ext/ocamlgraph/src/dot_parser.mly"
                  ( Attr_node _2 )
# 333 "src_ext/ocamlgraph/src/dot_parser.ml"
               : 'attr_stmt))
; (fun __caml_parser_env ->
    let _2 = (Parsing.peek_val __caml_parser_env 0 : 'attr_list) in
    Obj.repr(
# 99 "src_ext/ocamlgraph/src/dot_parser.mly"
                  ( Attr_edge _2 )
# 340 "src_ext/ocamlgraph/src/dot_parser.ml"
               : 'attr_stmt))
; (fun __caml_parser_env ->
    let _2 = (Parsing.peek_val __caml_parser_env 1 : 'node) in
    let _3 = (Parsing.peek_val __caml_parser_env 0 : 'edge_rhs_opt) in
    Obj.repr(
# 103 "src_ext/ocamlgraph/src/dot_parser.mly"
                           ( _2 :: _3 )
# 348 "src_ext/ocamlgraph/src/dot_parser.ml"
               : 'edge_rhs))
; (fun __caml_parser_env ->
    Obj.repr(
# 107 "src_ext/ocamlgraph/src/dot_parser.mly"
                ( [] )
# 354 "src_ext/ocamlgraph/src/dot_parser.ml"
               : 'edge_rhs_opt))
; (fun __caml_parser_env ->
    let _2 = (Parsing.peek_val __caml_parser_env 1 : 'node) in
    let _3 = (Parsing.peek_val __caml_parser_env 0 : 'edge_rhs_opt) in
    Obj.repr(
# 108 "src_ext/ocamlgraph/src/dot_parser.mly"
                           ( _2 :: _3 )
# 362 "src_ext/ocamlgraph/src/dot_parser.ml"
               : 'edge_rhs_opt))
; (fun __caml_parser_env ->
    let _1 = (Parsing.peek_val __caml_parser_env 0 : 'node_id) in
    Obj.repr(
# 112 "src_ext/ocamlgraph/src/dot_parser.mly"
           ( NodeId _1 )
# 369 "src_ext/ocamlgraph/src/dot_parser.ml"
               : 'node))
; (fun __caml_parser_env ->
    let _1 = (Parsing.peek_val __caml_parser_env 0 : 'subgraph) in
    Obj.repr(
# 113 "src_ext/ocamlgraph/src/dot_parser.mly"
           ( NodeSub _1 )
# 376 "src_ext/ocamlgraph/src/dot_parser.ml"
               : 'node))
; (fun __caml_parser_env ->
    let _1 = (Parsing.peek_val __caml_parser_env 1 : Dot_ast.id) in
    let _2 = (Parsing.peek_val __caml_parser_env 0 : 'port_opt) in
    Obj.repr(
# 117 "src_ext/ocamlgraph/src/dot_parser.mly"
              ( _1, _2 )
# 384 "src_ext/ocamlgraph/src/dot_parser.ml"
               : 'node_id))
; (fun __caml_parser_env ->
    Obj.repr(
# 121 "src_ext/ocamlgraph/src/dot_parser.mly"
                ( None )
# 390 "src_ext/ocamlgraph/src/dot_parser.ml"
               : 'port_opt))
; (fun __caml_parser_env ->
    let _1 = (Parsing.peek_val __caml_parser_env 0 : 'port) in
    Obj.repr(
# 122 "src_ext/ocamlgraph/src/dot_parser.mly"
                ( Some _1 )
# 397 "src_ext/ocamlgraph/src/dot_parser.ml"
               : 'port_opt))
; (fun __caml_parser_env ->
    let _2 = (Parsing.peek_val __caml_parser_env 0 : Dot_ast.id) in
    Obj.repr(
# 126 "src_ext/ocamlgraph/src/dot_parser.mly"
           ( try PortC (compass_pt _2)
             with Invalid_argument _ -> PortId (_2, None) )
# 405 "src_ext/ocamlgraph/src/dot_parser.ml"
               : 'port))
; (fun __caml_parser_env ->
    let _2 = (Parsing.peek_val __caml_parser_env 2 : Dot_ast.id) in
    let _4 = (Parsing.peek_val __caml_parser_env 0 : Dot_ast.id) in
    Obj.repr(
# 129 "src_ext/ocamlgraph/src/dot_parser.mly"
      ( let cp =
  	  try compass_pt _4 with Invalid_argument _ -> raise Parse_error
	in
	PortId (_2, Some cp) )
# 416 "src_ext/ocamlgraph/src/dot_parser.ml"
               : 'port))
; (fun __caml_parser_env ->
    Obj.repr(
# 136 "src_ext/ocamlgraph/src/dot_parser.mly"
                ( [] )
# 422 "src_ext/ocamlgraph/src/dot_parser.ml"
               : 'attr_list_opt))
; (fun __caml_parser_env ->
    let _1 = (Parsing.peek_val __caml_parser_env 0 : 'attr_list) in
    Obj.repr(
# 137 "src_ext/ocamlgraph/src/dot_parser.mly"
               ( _1 )
# 429 "src_ext/ocamlgraph/src/dot_parser.ml"
               : 'attr_list_opt))
; (fun __caml_parser_env ->
    let _2 = (Parsing.peek_val __caml_parser_env 1 : 'a_list) in
    Obj.repr(
# 141 "src_ext/ocamlgraph/src/dot_parser.mly"
                 ( [_2] )
# 436 "src_ext/ocamlgraph/src/dot_parser.ml"
               : 'attr_list))
; (fun __caml_parser_env ->
    let _2 = (Parsing.peek_val __caml_parser_env 2 : 'a_list) in
    let _4 = (Parsing.peek_val __caml_parser_env 0 : 'attr_list) in
    Obj.repr(
# 142 "src_ext/ocamlgraph/src/dot_parser.mly"
                           ( _2 :: _4 )
# 444 "src_ext/ocamlgraph/src/dot_parser.ml"
               : 'attr_list))
; (fun __caml_parser_env ->
    Obj.repr(
# 146 "src_ext/ocamlgraph/src/dot_parser.mly"
                ( None )
# 450 "src_ext/ocamlgraph/src/dot_parser.ml"
               : 'id_opt))
; (fun __caml_parser_env ->
    let _1 = (Parsing.peek_val __caml_parser_env 0 : Dot_ast.id) in
    Obj.repr(
# 147 "src_ext/ocamlgraph/src/dot_parser.mly"
                ( Some _1 )
# 457 "src_ext/ocamlgraph/src/dot_parser.ml"
               : 'id_opt))
; (fun __caml_parser_env ->
    let _1 = (Parsing.peek_val __caml_parser_env 1 : 'equality) in
    let _2 = (Parsing.peek_val __caml_parser_env 0 : 'comma_opt) in
    Obj.repr(
# 151 "src_ext/ocamlgraph/src/dot_parser.mly"
                     ( [_1] )
# 465 "src_ext/ocamlgraph/src/dot_parser.ml"
               : 'a_list))
; (fun __caml_parser_env ->
    ...
    Obj.repr(
# 152 "src_ext/ocamlgraph/src/dot_parser.mly"
                            ( _1 :: _3 )
# 474 "src_ext/ocamlgraph/src/dot_parser.ml"
               : 'a_list))
; (fun __caml_parser_env ->
    let _1 = (Parsing.peek_val __caml_parser_env 0 : Dot_ast.id) in
    Obj.repr(
# 156 "src_ext/ocamlgraph/src/dot_parser.mly"
     ( _1, None )
# 481 "src_ext/ocamlgraph/src/dot_parser.ml"
               : 'equality))
; (fun __caml_parser_env ->
    let _1 = (Parsing.peek_val __caml_parser_env 2 : Dot_ast.id) in
    let _3 = (Parsing.peek_val __caml_parser_env 0 : Dot_ast.id) in
    Obj.repr(
# 157 "src_ext/ocamlgraph/src/dot_parser.mly"
              ( _1, Some _3 )
# 489 "src_ext/ocamlgraph/src/dot_parser.ml"
               : 'equality))
; (fun __caml_parser_env ->
    Obj.repr(
# 161 "src_ext/ocamlgraph/src/dot_parser.mly"
                ( () )
# 495 "src_ext/ocamlgraph/src/dot_parser.ml"
               : 'comma_opt))
; (fun __caml_parser_env ->
    Obj.repr(
# 162 "src_ext/ocamlgraph/src/dot_parser.mly"
                ( () )
# 501 "src_ext/ocamlgraph/src/dot_parser.ml"
               : 'comma_opt))
; (fun __caml_parser_env ->
    let _2 = (Parsing.peek_val __caml_parser_env 0 : Dot_ast.id) in
    Obj.repr(
# 166 "src_ext/ocamlgraph/src/dot_parser.mly"
              ( SubgraphId _2 )
# 508 "src_ext/ocamlgraph/src/dot_parser.ml"
               : 'subgraph))
; (fun __caml_parser_env ->
    let _2 = (Parsing.peek_val __caml_parser_env 3 : Dot_ast.id) in
    let _4 = (Parsing.peek_val __caml_parser_env 1 : 'stmt_list) in
    Obj.repr(
# 167 "src_ext/ocamlgraph/src/dot_parser.mly"
                                  ( SubgraphDef (Some _2, _4) )
# 516 "src_ext/ocamlgraph/src/dot_parser.ml"
               : 'subgraph))
; (fun __caml_parser_env ->
    let _3 = (Parsing.peek_val __caml_parser_env 1 : 'stmt_list) in
    Obj.repr(
# 168 "src_ext/ocamlgraph/src/dot_parser.mly"
                               ( SubgraphDef (None, _3) )
# 523 "src_ext/ocamlgraph/src/dot_parser.ml"
               : 'subgraph))
; (fun __caml_parser_env ->
    let _2 = (Parsing.peek_val __caml_parser_env 1 : 'stmt_list) in
    Obj.repr(
# 169 "src_ext/ocamlgraph/src/dot_parser.mly"
                      ( SubgraphDef (None, _2) )
# 530 "src_ext/ocamlgraph/src/dot_parser.ml"
               : 'subgraph))
(* Entry file *)
