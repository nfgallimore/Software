# 20 "src_ext/ocamlgraph/src/dot_lexer.mll"
...
# 25 "_obuild/graph/temp/dot_lexer.ml"
...
and __ocaml_lex_token_rec lexbuf __ocaml_lex_state =
  match Lexing.engine __ocaml_lex_tables __ocaml_lex_state lexbuf with
      | 0 ->
# 52 "src_ext/ocamlgraph/src/dot_lexer.mll"
      ( token lexbuf )
# 191 "_obuild/graph/temp/dot_lexer.ml"

  | 1 ->
# 54 "src_ext/ocamlgraph/src/dot_lexer.mll"
      ( token lexbuf )
# 196 "_obuild/graph/temp/dot_lexer.ml"

  | 2 ->
# 56 "src_ext/ocamlgraph/src/dot_lexer.mll"
      ( comment lexbuf; token lexbuf )
# 201 "_obuild/graph/temp/dot_lexer.ml"

  | 3 ->
# 58 "src_ext/ocamlgraph/src/dot_lexer.mll"
      ( COLON )
# 206 "_obuild/graph/temp/dot_lexer.ml"

  | 4 ->
# 60 "src_ext/ocamlgraph/src/dot_lexer.mll"
      ( COMMA )
# 211 "_obuild/graph/temp/dot_lexer.ml"

  | 5 ->
# 62 "src_ext/ocamlgraph/src/dot_lexer.mll"
      ( SEMICOLON )
# 216 "_obuild/graph/temp/dot_lexer.ml"

  | 6 ->
# 64 "src_ext/ocamlgraph/src/dot_lexer.mll"
      ( EQUAL )
# 221 "_obuild/graph/temp/dot_lexer.ml"

  | 7 ->
# 66 "src_ext/ocamlgraph/src/dot_lexer.mll"
      ( LBRA )
# 226 "_obuild/graph/temp/dot_lexer.ml"

  | 8 ->
# 68 "src_ext/ocamlgraph/src/dot_lexer.mll"
      ( RBRA )
# 231 "_obuild/graph/temp/dot_lexer.ml"

  | 9 ->
# 70 "src_ext/ocamlgraph/src/dot_lexer.mll"
      ( LSQ )
# 236 "_obuild/graph/temp/dot_lexer.ml"

  | 10 ->
# 72 "src_ext/ocamlgraph/src/dot_lexer.mll"
      ( RSQ )
# 241 "_obuild/graph/temp/dot_lexer.ml"

  | 11 ->
# 74 "src_ext/ocamlgraph/src/dot_lexer.mll"
      ( EDGEOP )
# 246 "_obuild/graph/temp/dot_lexer.ml"

  | 12 ->
let
# 75 "src_ext/ocamlgraph/src/dot_lexer.mll"
             s
# 252 "_obuild/graph/temp/dot_lexer.ml"
= Lexing.sub_lexeme lexbuf lexbuf.Lexing.lex_start_pos lexbuf.Lexing.lex_curr_pos in
# 76 "src_ext/ocamlgraph/src/dot_lexer.mll"
      ( try keyword s with Not_found -> ID (Ident s) )
# 256 "_obuild/graph/temp/dot_lexer.ml"

  | 13 ->
let
# 77 "src_ext/ocamlgraph/src/dot_lexer.mll"
              s
# 262 "_obuild/graph/temp/dot_lexer.ml"
= Lexing.sub_lexeme lexbuf lexbuf.Lexing.lex_start_pos lexbuf.Lexing.lex_curr_pos in
# 78 "src_ext/ocamlgraph/src/dot_lexer.mll"
      ( ID (Number s) )
# 266 "_obuild/graph/temp/dot_lexer.ml"

  | 14 ->
# 80 "src_ext/ocamlgraph/src/dot_lexer.mll"
      ( Buffer.clear string_buf; 
	let s = string lexbuf in
	ID (String s) )
# 273 "_obuild/graph/temp/dot_lexer.ml"

  | 15 ->
# 84 "src_ext/ocamlgraph/src/dot_lexer.mll"
      ( Buffer.clear string_buf; 
	html lexbuf; 
	ID (Html (Buffer.contents string_buf)) )
# 280 "_obuild/graph/temp/dot_lexer.ml"

  | 16 ->
# 88 "src_ext/ocamlgraph/src/dot_lexer.mll"
      ( EOF )
# 285 "_obuild/graph/temp/dot_lexer.ml"

  | 17 ->
let
# 89 "src_ext/ocamlgraph/src/dot_lexer.mll"
         c
# 291 "_obuild/graph/temp/dot_lexer.ml"
= Lexing.sub_lexeme_char lexbuf lexbuf.Lexing.lex_start_pos in
# 90 "src_ext/ocamlgraph/src/dot_lexer.mll"
      ( failwith ("Dot_lexer: invalid character " ^ String.make 1 c) )
# 295 "_obuild/graph/temp/dot_lexer.ml"
...
and __ocaml_lex_string_rec lexbuf __ocaml_lex_state =
  match Lexing.engine __ocaml_lex_tables __ocaml_lex_state lexbuf with
      | 0 ->
# 94 "src_ext/ocamlgraph/src/dot_lexer.mll"
      ( Buffer.contents string_buf )
# 306 "_obuild/graph/temp/dot_lexer.ml"

  | 1 ->
# 96 "src_ext/ocamlgraph/src/dot_lexer.mll"
      ( Buffer.add_char string_buf '"';
	string lexbuf )
# 312 "_obuild/graph/temp/dot_lexer.ml"

  | 2 ->
let
# 98 "src_ext/ocamlgraph/src/dot_lexer.mll"
         c
# 318 "_obuild/graph/temp/dot_lexer.ml"
= Lexing.sub_lexeme_char lexbuf lexbuf.Lexing.lex_start_pos in
# 99 "src_ext/ocamlgraph/src/dot_lexer.mll"
      ( Buffer.add_char string_buf c;
	string lexbuf )
# 323 "_obuild/graph/temp/dot_lexer.ml"

  | 3 ->
# 102 "src_ext/ocamlgraph/src/dot_lexer.mll"
      ( failwith ("Dot_lexer: unterminated string literal") )
# 328 "_obuild/graph/temp/dot_lexer.ml"
...
and __ocaml_lex_html_rec lexbuf __ocaml_lex_state =
  match Lexing.engine __ocaml_lex_tables __ocaml_lex_state lexbuf with
      | 0 ->
# 106 "src_ext/ocamlgraph/src/dot_lexer.mll"
      ( () )
# 339 "_obuild/graph/temp/dot_lexer.ml"

  | 1 ->
# 108 "src_ext/ocamlgraph/src/dot_lexer.mll"
      ( Buffer.add_char string_buf '<'; html lexbuf;
	Buffer.add_char string_buf '>'; html lexbuf )
# 345 "_obuild/graph/temp/dot_lexer.ml"

  | 2 ->
let
# 110 "src_ext/ocamlgraph/src/dot_lexer.mll"
         c
# 351 "_obuild/graph/temp/dot_lexer.ml"
= Lexing.sub_lexeme_char lexbuf lexbuf.Lexing.lex_start_pos in
# 111 "src_ext/ocamlgraph/src/dot_lexer.mll"
      ( Buffer.add_char string_buf c;
	html lexbuf )
# 356 "_obuild/graph/temp/dot_lexer.ml"

  | 3 ->
# 114 "src_ext/ocamlgraph/src/dot_lexer.mll"
      ( failwith ("Dot_lexer: unterminated html literal") )
# 361 "_obuild/graph/temp/dot_lexer.ml"
...
and __ocaml_lex_comment_rec lexbuf __ocaml_lex_state =
  match Lexing.engine __ocaml_lex_tables __ocaml_lex_state lexbuf with
      | 0 ->
# 118 "src_ext/ocamlgraph/src/dot_lexer.mll"
      ( () )
# 372 "_obuild/graph/temp/dot_lexer.ml"

  | 1 ->
# 120 "src_ext/ocamlgraph/src/dot_lexer.mll"
      ( comment lexbuf )
# 377 "_obuild/graph/temp/dot_lexer.ml"

  | 2 ->
# 122 "src_ext/ocamlgraph/src/dot_lexer.mll"
      ( failwith "Dot_lexer: unterminated comment" )
# 382 "_obuild/graph/temp/dot_lexer.ml"
